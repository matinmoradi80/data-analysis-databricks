...
|---|---|
| **Tariq Aziz** | Bronze ingestion layer, Gold aggregations, ML model, data visualization dashboard, FastAPI prediction service, data contract|
| **Matin Moradi**  | Silver ETL layer, data lineage, automated tests and GitHub Actions CI, External visualization and data sharing via API|

Both contributed in Documentation & Presentation.


## AI Tool Usage Disclosure

Claude Code (Anthropic): getting architecture ideas, finding bugs in code, language and style improvement in documentation
...
We (Tariq and Matin) are both coming from the countries with the lowest air quality which causes many problems. This was our initial motivation to work on the lung cancer and air quality data together. 
